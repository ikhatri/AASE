...
def setup_car_DBN_slice(
    filepath: Path,
    light: pom.ConditionalProbabilityTable,
    light_belief: pom.DiscreteDistribution,
    position_belief: pom.DiscreteDistribution,
    velocity_belief: pom.DiscreteDistribution,
    car_id: str,
    iter: int = 0,
):
    """
...
def add_cars_DBN(
    ...
    for cross_id in cross_car_ids:
        node_names, nodes, edges, = setup_car_DBN_slice(
            ...
            cross_light,
            cross_light_belief,
            car_beliefs[cross_id]["pos"],
            car_beliefs[cross_id]["vel"],
            cross_id,
            iter,
        )
        names.extend(node_names)
...
def predict_DBN(dbn, names, evidence, timestep, iterations=10, jobs=1):
    ...
    for i, y in enumerate(y_hat):
        if (
            "system_" + str(timestep) in names[i]
            or "position_" + str(timestep) in names[i]
            or "velocity_" + str(timestep) in names[i]
        ):
...
if __name__ == "__main__":
    ...
    evidence_1 = {
        "0_evidence_pos_1": "at",
        "0_evidence_vel_1": "med",
        "1_evidence_pos_1": "at",
        "1_evidence_vel_1": "low",
        "2_evidence_pos_1": "straight",
        "2_evidence_vel_1": "zero",
        "3_evidence_pos_1": "at",
        "3_evidence_vel_1": "low",
        "4_evidence_pos_1": "at",
        "4_evidence_vel_1": "zero",
    }
    evidence_2 = {
        "0_evidence_pos_2": "at",
        "0_evidence_vel_2": "med",
        "1_evidence_pos_2": "at",
        "1_evidence_vel_2": "med",
        "2_evidence_pos_2": "straight",
        "2_evidence_vel_2": "low",
        "3_evidence_pos_2": "at",
        "3_evidence_vel_2": "zero",
        "4_evidence_pos_2": "at",
        "4_evidence_vel_2": "zero",
    }
